...
public class Auto_C2B2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        trajSeq = AutonomousTrajectories.trajectory_C2_B2(drive, lift, wrist, intake);
        ...
        drive.followTrajectorySequence(AutonomousTrajectories.trajectory_ParkLeft(ZONE_ONE, true, drive, lift, wrist, intake));
