...
public class Auto_C2B3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        trajSeq = AutonomousTrajectories.trajectory_C2_B3(drive, lift, wrist, intake);
        ...
        trajSeq_Park = AutonomousTrajectories.trajectory_ParkLeft(parkZone, true, drive, lift, wrist, intake);
